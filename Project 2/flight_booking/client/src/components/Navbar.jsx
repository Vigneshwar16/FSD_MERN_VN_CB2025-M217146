  ...
  return (
    <>
      <div className="navbar">
        {!usertype ? (
          <>
            <h3>SmartBridge Flights ✈️</h3>

            <div className="nav-options">
              <p onClick={() => navigate("/")} className="btn btn-secondary fw-bold">Landing Page</p>
              <p onClick={() => navigate("/auth")} className="btn btn-secondary fw-bold">Login</p>
            </div>
          </>
        ) : (
          <>
            {usertype === "customer" ? (
              ...
              <>
                <h3>SmartBridge Flights ✈️ (Admin)</h3>
                <div className="nav-options">
              ...
              <>
                <h3>SmartBridge Flights ✈️(Operator)</h3>
                <div className="nav-options">
